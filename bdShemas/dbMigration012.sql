...
INSERT INTO order_state(id, name, runtime, extra, tech, book_part) VALUES (505, 'Отменен синхронизацией', 0, 0, 0, 0);
UPDATE order_state SET name = 'Отменен оператором' WHERE id = 510;
