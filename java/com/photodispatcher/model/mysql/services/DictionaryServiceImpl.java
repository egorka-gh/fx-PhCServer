...
public class DictionaryServiceImpl extends AbstractDAO implements DictionaryService {
	...
	@Override
	public SelectResult<FieldValue> getProductionValueList(){
		SelectResult<FieldValue> result;
		String sql="SELECT id value, name label FROM production";
		result=runSelect(FieldValue.class, sql);
		return result;
	}
	...
	@Override
	public SelectResult<FieldValue> getOrderProgramValueList(){
		SelectResult<FieldValue> result;
		String sql="SELECT id value, name label FROM order_program";
		result=runSelect(FieldValue.class, sql);
		return result;
	}
	...
	@Override
	public SelectResult<FieldValue> getInterlayerValueList(){
		SelectResult<FieldValue> result;
		String sql="SELECT id value, name label FROM layerset l WHERE l.layerset_group = 0 AND l.subset_type = 1 ORDER BY l.name";
		result=runSelect(FieldValue.class, sql);
		return result;
	}

	@Override
	public SelectResult<FieldValue> getPrnStrategyValueList(){
		SelectResult<FieldValue> result;
		String sql="SELECT id value, name label FROM prn_strategy_type";
		result=runSelect(FieldValue.class, sql);
		return result;
	}
